...
<form:form action="actor/registerProvider.do" modelAttribute="registerForm" id="myform">
	...
	<spring:message code="actor.userAcc"/> :<br>
	...
	<div id="some-div">
  	...
  	The pattern of this field must adhere to XXXNNNNNNNNN where 
